...
namespace lesgriots.DataEF;

public partial class griosDbContext : DbContext
{
    public griosDbContext()
    {
    }

    public griosDbContext(DbContextOptions<griosDbContext> options)
        : base(options)
    {
    }
